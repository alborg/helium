...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>fys4411/examples/Blocking/src/main.cpp at master · ComputationalPhysics/fys4411 · GitHub</title>
...
<meta content="YaNiN0Pb9SF6YbZceqiuybx2UFOv9AeI/iakB7nYRjQ=" name="csrf-token" />
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/assets/github2-30896c5685c3dd8da766a4fd3065a563107c9370.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="072f5e17a108af01465503ae7aeacf05">
        ...
        <link data-pjax-transient rel='permalink' href='/ComputationalPhysics/fys4411/blob/3f9d63eb6de6da4384f7d4b1ce1b0c2f5984dbbc/examples/Blocking/src/main.cpp'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button" href="/login?return_to=%2FComputationalPhysics%2Ffys4411%2Fblob%2Fmaster%2Fexamples%2FBlocking%2Fsrc%2Fmain.cpp">Sign in</a>
    </div>
        ...
        <div class="select-menu-modal">
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="branches">
            ...
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item selected">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/ComputationalPhysics/fys4411/blob/master/examples/Blocking/src/main.cpp" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
                </div> <!-- /.select-menu-item -->
            </div>
...
<!-- blob contrib key: blob_contributors:v21:852b3beb0dd5bae3e928bc8678e15eb7 -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:852b3beb0dd5bae3e928bc8678e15eb7 -->
...
<div id="slider">
  ...
  <div class="commit file-history-tease">
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/ComputationalPhysics/fys4411/blob/3f9d63eb6de6da4384f7d4b1ce1b0c2f5984dbbc/examples/Blocking/src/main.cpp" data-title="fys4411/examples/Blocking/src/main.cpp at master · ComputationalPhysics/fys4411 · GitHub" data-type="blob">
            ...
            <div class="meta">
              ...
              <div class="actions">
                <div class="button-group">
                  ...
                  <a href="/ComputationalPhysics/fys4411/raw/master/examples/Blocking/src/main.cpp" class="button minibutton " id="raw-url">Raw</a>
                    <a href="/ComputationalPhysics/fys4411/blame/master/examples/Blocking/src/main.cpp" class="button minibutton ">Blame</a>
                  <a href="/ComputationalPhysics/fys4411/commits/master/examples/Blocking/src/main.cpp" class="button minibutton " rel="nofollow">History</a>
                </div><!-- /.button-group -->
              </div><!-- /.actions -->
...
<span id="L21" rel="#L21">21</span>
          ...
          <td class="blob-line-code">
                  <div class="highlight"><pre><div class='line' id='LC1'><span class="cp">#include &lt;iostream&gt;</span></div><div class='line' id='LC2'><span class="cp">#include &lt;armadillo&gt;</span></div><div class='line' id='LC3'><span class="cp">#include &lt;blocking.h&gt;</span></div><div class='line' id='LC4'><span class="cp">#include &lt;cstdlib&gt;</span></div><div class='line' id='LC5'><br/></div><div class='line' id='LC6'><span class="k">using</span> <span class="k">namespace</span> <span class="n">std</span><span class="p">;</span></div><div class='line' id='LC7'><span class="k">using</span> <span class="k">namespace</span> <span class="n">arma</span><span class="p">;</span></div><div class='line' id='LC8'><span class="kt">int</span> <span class="nf">main</span><span class="p">()</span></div><div class='line' id='LC9'><span class="p">{</span></div><div class='line' id='LC10'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">string</span> <span class="n">dataPath</span> <span class="o">=</span> <span class="s">&quot;../DATA&quot;</span><span class="p">;</span></div><div class='line' id='LC11'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">Blocking</span> <span class="n">block</span><span class="p">(</span><span class="n">dataPath</span><span class="p">);</span></div><div class='line' id='LC12'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">block</span><span class="p">.</span><span class="n">doBlocking</span><span class="p">();</span></div><div class='line' id='LC13'><br/></div><div class='line' id='LC14'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="c1">// Plotting result</span></div><div class='line' id='LC15'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">string</span> <span class="n">pythonPath</span> <span class="o">=</span> <span class="s">&quot;python &quot;</span> <span class="o">+</span> <span class="n">dataPath</span></div><div class='line' id='LC16'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="o">+</span> <span class="s">&quot;/plotBlocking.py &quot;</span></div><div class='line' id='LC17'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="o">+</span> <span class="n">dataPath</span> <span class="o">+</span> <span class="s">&quot;/blocking.mat&quot;</span><span class="p">;</span></div><div class='line' id='LC18'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">system</span><span class="p">(</span><span class="n">pythonPath</span><span class="p">.</span><span class="n">c_str</span><span class="p">());</span></div><div class='line' id='LC19'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="mi">0</span><span class="p">;</span></div><div class='line' id='LC20'><span class="p">}</span></div><div class='line' id='LC21'><br/></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.04564s from fe1.rs.github.com">GitHub</span>, Inc. All rights reserved.</p>
    <a class="left" href="/">
  ...
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.04603' data-host='fe1'></span>
