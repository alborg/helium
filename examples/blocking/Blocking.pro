...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>fys4411/examples/Blocking/src/Blocking.pro at master · ComputationalPhysics/fys4411 · GitHub</title>
...
<meta content="YaNiN0Pb9SF6YbZceqiuybx2UFOv9AeI/iakB7nYRjQ=" name="csrf-token" />
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/assets/github2-30896c5685c3dd8da766a4fd3065a563107c9370.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="072f5e17a108af01465503ae7aeacf05">
        ...
        <link data-pjax-transient rel='permalink' href='/ComputationalPhysics/fys4411/blob/3f9d63eb6de6da4384f7d4b1ce1b0c2f5984dbbc/examples/Blocking/src/Blocking.pro'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button" href="/login?return_to=%2FComputationalPhysics%2Ffys4411%2Fblob%2Fmaster%2Fexamples%2FBlocking%2Fsrc%2FBlocking.pro">Sign in</a>
    </div>
        ...
        <div class="select-menu-modal">
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="branches">
            ...
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item selected">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/ComputationalPhysics/fys4411/blob/master/examples/Blocking/src/Blocking.pro" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
                </div> <!-- /.select-menu-item -->
            </div>
...
<!-- blob contrib key: blob_contributors:v21:461bb429d4ef01a35d71139868b93e07 -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:461bb429d4ef01a35d71139868b93e07 -->
...
<div id="slider">
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/ComputationalPhysics/fys4411/blob/3f9d63eb6de6da4384f7d4b1ce1b0c2f5984dbbc/examples/Blocking/src/Blocking.pro" data-title="fys4411/examples/Blocking/src/Blocking.pro at master · ComputationalPhysics/fys4411 · GitHub" data-type="blob">
            ...
            <div class="meta">
              ...
              <div class="actions">
                <div class="button-group">
                  ...
                  <a href="/ComputationalPhysics/fys4411/raw/master/examples/Blocking/src/Blocking.pro" class="button minibutton " id="raw-url">Raw</a>
                    <a href="/ComputationalPhysics/fys4411/blame/master/examples/Blocking/src/Blocking.pro" class="button minibutton ">Blame</a>
                  <a href="/ComputationalPhysics/fys4411/commits/master/examples/Blocking/src/Blocking.pro" class="button minibutton " rel="nofollow">History</a>
                </div><!-- /.button-group -->
              </div><!-- /.actions -->
...
<span id="L13" rel="#L13">13</span>
          ...
          <td class="blob-line-code">
                  <div class="highlight"><pre><div class='line' id='LC1'><span class="nv">TEMPLATE</span> <span class="o">=</span> <span class="s-Atom">app</span></div><div class='line' id='LC2'><span class="nv">CONFIG</span> <span class="s-Atom">+=</span> <span class="s-Atom">console</span></div><div class='line' id='LC3'><span class="nv">CONFIG</span> <span class="s-Atom">-=</span> <span class="s-Atom">app_bundle</span></div><div class='line' id='LC4'><span class="nv">CONFIG</span> <span class="s-Atom">-=</span> <span class="s-Atom">qt</span></div><div class='line' id='LC5'><br/></div><div class='line' id='LC6'><span class="nv">SOURCES</span> <span class="s-Atom">+=</span> <span class="s-Atom">main</span><span class="p">.</span><span class="s-Atom">cpp</span> <span class="s-Atom">\</span></div><div class='line' id='LC7'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="s-Atom">blocking</span><span class="p">.</span><span class="s-Atom">cpp</span></div><div class='line' id='LC8'><br/></div><div class='line' id='LC9'><span class="nv">HEADERS</span> <span class="s-Atom">+=</span> <span class="s-Atom">\</span></div><div class='line' id='LC10'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="s-Atom">blocking</span><span class="p">.</span><span class="s-Atom">h</span></div><div class='line' id='LC11'><br/></div><div class='line' id='LC12'><span class="nv">QMAKE_CXXFLAGS_DEBUG</span> <span class="s-Atom">+=</span> <span class="o">-</span><span class="s-Atom">std</span><span class="o">=</span><span class="s-Atom">c++</span><span class="m">0</span><span class="s-Atom">x</span></div><div class='line' id='LC13'><span class="nv">QMAKE_CXXFLAGS_RELEASE</span> <span class="s-Atom">+=</span> <span class="o">-</span><span class="s-Atom">std</span><span class="o">=</span><span class="s-Atom">c++</span><span class="m">0</span><span class="s-Atom">x</span></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.16783s from fe1.rs.github.com">GitHub</span>, Inc. All rights reserved.</p>
    <a class="left" href="/">
  ...
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.16822' data-host='fe1'></span>
